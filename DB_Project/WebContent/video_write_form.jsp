...
%>
<div>
	<font size="5"><b>※영화/만화 문구 만들기※</b></font>
	...
	<table border width="600" height ="200">
		...
		<tr height="25">
			<th>캐릭터</th>
			<td><input type="text" name = "Character" style="width:90%;"></td>
			<th>장르</th>
			<td><input type="text" name = "Genre" style="width:90%;"></td>
			<th>종류</th>
			<td>
